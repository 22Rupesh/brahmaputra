...
const Header: React.FC<HeaderProps> = ({ currentUser, viewedUser, setViewedUser, allUsers, onLogout, onToggleSidebar }) => {
  ...
  return (
    <header className="h-20 bg-white border-b border-brand-border flex-shrink-0 flex items-center justify-between px-4 sm:px-8">
      <div className="flex items-center space-x-4">
        ...
        <h2 className="text-xl sm:text-2xl font-semibold text-brand-dark hidden sm:block">Productivity</h2>
         {canViewOthers && (
            <div className="flex items-center space-x-2">
                <label htmlFor="user-select" className="text-sm font-medium text-gray-700 hidden lg:block">Viewing:</label>
                <select 
                    id="user-select" 
                    value={viewedUser.id} 
      ...
      <div className="flex items-center space-x-2 sm:space-x-6">
        ...
        <img
          className="w-12 h-12 rounded-full object-cover bg-gray-200 p-1"
